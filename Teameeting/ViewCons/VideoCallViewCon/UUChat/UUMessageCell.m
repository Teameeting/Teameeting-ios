...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
       ...
       // [self.contentView addSubview:headImageBackView];
        ...
        self.btnContent.autoresizingMask = UIViewAutoresizingFlexibleRightMargin;
        self.btnContent.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
        self.btnContent.contentEdgeInsets = UIEdgeInsetsMake(0,10, 0, 0);
...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame isVertical:(BOOL)vertical{
   ...
   // [messageFrame setMessage:messageFrame.message];
    ...
    self.labelTime.frame = CGRectMake(messageFrame.contentF.origin.x - 5,CGRectGetMaxY(messageFrame.contentF) - 25, CGRectGetWidth(messageFrame.contentF) - 5, 20);
